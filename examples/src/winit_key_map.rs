...
pub fn key_code_to_rf(code: KeyCode) -> RfKey {
    ...
    match code {
        ...
        K::Digit0 => RfKey::Digit0,
        K::Digit1 => RfKey::Digit1,
        K::Digit2 => RfKey::Digit2,
        K::Digit3 => RfKey::Digit3,
        K::Digit4 => RfKey::Digit4,
        K::Digit5 => RfKey::Digit5,
        K::Digit6 => RfKey::Digit6,
        K::Digit7 => RfKey::Digit7,
        K::Digit8 => RfKey::Digit8,
        K::Digit9 => RfKey::Digit9,

        K::Numpad0 => RfKey::NumberPad0,
        K::Numpad1 => RfKey::NumberPad1,
        K::Numpad2 => RfKey::NumberPad2,
        K::Numpad3 => RfKey::NumberPad3,
        K::Numpad4 => RfKey::NumberPad4,
        K::Numpad5 => RfKey::NumberPad5,
        K::Numpad6 => RfKey::NumberPad6,
        K::Numpad7 => RfKey::NumberPad7,
        K::Numpad8 => RfKey::NumberPad8,
        K::Numpad9 => RfKey::NumberPad9,
        ...
        K::ShiftLeft => RfKey::ShiftLeft,
        K::ShiftRight => RfKey::ShiftRight,
        K::ControlLeft => RfKey::ControlLeft,
        K::ControlRight => RfKey::ControlRight,
        K::AltLeft => RfKey::AltLeft,
        K::AltRight => RfKey::AltRight,
        K::SuperLeft => RfKey::MetaLeft,
        K::SuperRight => RfKey::MetaRight,
        ...
        K::ArrowUp => RfKey::ArrowUp,
        K::ArrowDown => RfKey::ArrowDown,
        K::ArrowLeft => RfKey::ArrowLeft,
        K::ArrowRight => RfKey::ArrowRight,
        K::Home => RfKey::Home,
        K::End => RfKey::End,
        K::PageUp => RfKey::PageUp,
        K::PageDown => RfKey::PageDown,
        K::Insert => RfKey::Insert,
        K::Delete => RfKey::Delete,

        K::Enter => RfKey::Enter,
        K::Tab => RfKey::Tab,
        K::Space => RfKey::Space,
        K::Backspace => RfKey::Backspace,
        K::Escape => RfKey::Escape,
        K::CapsLock => RfKey::CapsLock,
        K::NumLock => RfKey::NumLock,
        K::ScrollLock => RfKey::ScrollLock,
        K::PrintScreen => RfKey::PrintScreen,
        K::Pause => RfKey::Pause,
        K::ContextMenu => RfKey::ContextMenu,

        K::Backquote => RfKey::Backquote,
        K::Minus => RfKey::Minus,
        K::Equal => RfKey::Equal,
        K::BracketLeft => RfKey::BracketLeft,
        K::BracketRight => RfKey::BracketRight,
        K::Backslash => RfKey::Backslash,
        K::Semicolon => RfKey::Semicolon,
        K::Quote => RfKey::Quote,
        K::Comma => RfKey::Comma,
        K::Period => RfKey::Period,
        K::Slash => RfKey::Slash,
