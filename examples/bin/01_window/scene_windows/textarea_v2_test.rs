...
#[component]
pub fn TextareaV2Test(theme: Theme) -> RsxNode {
    ...
    rsx! {
        <Element style={{
            ...
            // v2 design A1: TextArea2 is not-IS-A Element. Box model
            // (width / height / background / border / border-radius /
            // padding) lives on a wrapping <Element>. TextArea2's own
