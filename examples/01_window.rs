...
use rfgui::ui::{
    Binding, GlobalKey, RsxNode, component, globalState, on_click, on_focus, rsx, take_state_dirty,
    use_state,
};
use rfgui::{
...
#[component]
fn GlobalKeyCounterCard(title: String) -> RsxNode {
...
#[component]
fn GlobalKeyRenderTestBlock() -> RsxNode {
