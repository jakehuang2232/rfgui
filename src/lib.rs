...
macro_rules! __rfgui_style_assign_expr {
    ($builder:ident, $kind:ident, position, $value:expr) => {
        $builder.position($value);
    };
    ($builder:ident, $kind:ident, width, $value:expr) => {
        $builder.width($value);
    };
    ($builder:ident, $kind:ident, height, $value:expr) => {
        $builder.height($value);
    };
    ($builder:ident, $kind:ident, min_width, $value:expr) => {
        $builder.min_width($value);
    };
    ($builder:ident, $kind:ident, max_width, $value:expr) => {
        $builder.max_width($value);
    };
    ($builder:ident, $kind:ident, min_height, $value:expr) => {
        $builder.min_height($value);
    };
    ($builder:ident, $kind:ident, max_height, $value:expr) => {
        $builder.max_height($value);
    };
    ($builder:ident, $kind:ident, layout, $value:expr) => {
        $builder.layout($value);
    };
    ($builder:ident, $kind:ident, cross_size, $value:expr) => {
        $builder.cross_size($value);
    };
    ($builder:ident, $kind:ident, align, $value:expr) => {
        $builder.align($value);
    };
    ($builder:ident, $kind:ident, flex, $value:expr) => {
        $builder.flex($value);
    };
    ($builder:ident, $kind:ident, gap, $value:expr) => {
        $builder.gap($value);
    };
    ($builder:ident, $kind:ident, scroll_direction, $value:expr) => {
        $builder.scroll_direction($value);
    };
    ($builder:ident, $kind:ident, cursor, $value:expr) => {
        $builder.cursor($value);
    };
    ($builder:ident, $kind:ident, color, $value:expr) => {
        $builder.color($value);
    };
    ($builder:ident, $kind:ident, border, $value:expr) => {
        $builder.border($value);
    };
    ($builder:ident, $kind:ident, background, $value:expr) => {
        $builder.background($value);
    };
    ($builder:ident, $kind:ident, background_color, $value:expr) => {
        $builder.background_color($value);
    };
    ($builder:ident, $kind:ident, font, $value:expr) => {
        $builder.font($value);
    };
    ($builder:ident, $kind:ident, font_size, $value:expr) => {
        $builder.font_size($value);
    };
    ($builder:ident, $kind:ident, font_weight, $value:expr) => {
        $builder.font_weight($value);
    };
    ($builder:ident, $kind:ident, text_wrap, $value:expr) => {
        $builder.text_wrap($value);
    };
    ($builder:ident, $kind:ident, border_radius, $value:expr) => {
        $builder.border_radius($value);
    };
    ($builder:ident, $kind:ident, opacity, $value:expr) => {
        $builder.opacity($value);
    };
    ($builder:ident, $kind:ident, box_shadow, $value:expr) => {
        $builder.box_shadow($value);
    };
    ($builder:ident, $kind:ident, padding, $value:expr) => {
        $builder.padding($value);
    };
    ($builder:ident, $kind:ident, transform, $value:expr) => {
        $builder.transform($value);
    };
    ($builder:ident, $kind:ident, transform_origin, $value:expr) => {
        $builder.transform_origin($value);
    };
    ($builder:ident, $kind:ident, transition, $value:expr) => {
        $builder.transition($value);
    };
    ($builder:ident, $kind:ident, animator, $value:expr) => {
        $builder.animator($value);
    };
    ($builder:ident, selection, background, $value:expr) => {
        $builder.background($value);
    };
}
