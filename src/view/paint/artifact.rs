...
// Legacy recording-context capabilities. `PaintRecordingContext` still carries
// the pre-V2 admission witnesses; they leave with `legacy_admission` in the
// Stage C hard cutover.
use super::legacy_admission::{
    PaintScrollAtomicProjectionTextAreaRecorderWitness, PaintScrollInteractiveTextAreaSubtreeWitness,
