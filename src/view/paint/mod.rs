...
pub(crate) use compiler::{
    ...
    RootEffectRasterInputs, RootEffectRasterStamp, SealedArtifactSurfaceResidentSet,
    SingleTargetSurfaceDagPrepareError,
    ...
    retained_surface_raster_stamp_is_canonical_at_depth, seal_artifact_surface_resident_set,
