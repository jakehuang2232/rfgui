...
pub use frame_graph::{
    ...
    BufferVersionId, CompiledGraph, CompiledPass, CompiledPassResourceTransition, CompiledResource,
    CompiledResourceTimeline, CompiledResourceTransition, ComputePassDescriptor,
    ComputeRecordContext, ConsumedVersion, ExternalAllocationPlanEntry, ExternalResource,
    ExternalSink, ExternalSinkId, ExternalSinkKind, ExternalSinkTarget, FrameGraph,
    ...
    GraphicsPassDescriptor, GraphicsPassMergePolicy, GraphicsPipelineRequirements,
    GraphicsRecordContext, GraphicsStencilAspectDescriptor, PassDescriptor, PassDetails,
    PassHandle, PassKind, PassResourceUsage, PrepareContext, ProducedVersion, RecordContext,
    ResourceAccess, ResourceCache, ResourceHandle, ResourceKind, ResourceLifetime,
    ResourceMetadata, ResourceState, ResourceUsage, ResourceVersionId, SampleCountPolicy,
    ScissorPolicy, TextureAllocationPlanEntry, TextureAspectState, TextureResourceState,
    TextureVersionId, TransferPassDescriptor, TransferRecordContext, ViewportPolicy,
};
